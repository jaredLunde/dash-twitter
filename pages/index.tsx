    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          <div className={row({ distribute: "between", align: "center" })}>
            <div
              className={clsx(
                row({ gap: "sm", pad: "sm" }),
                text({ color: "primary" })
            ...
            >
              <IconButton src="/icons/image.svg" color="primary" size="lg" />
              <IconButton
                src="/icons/bar-chart-2.svg"
                color="primary"
                size="lg"
              />
              <IconButton src="/icons/smile.svg" color="primary" size="lg" />
              <IconButton src="/icons/calendar.svg" color="primary" size="lg" />
            </div>
